...
const Notifications = core.factory((_props, ref) => {
  ...
  const items = data.notifications.map(({ style: notificationStyle, ...notification }) => /* @__PURE__ */ React__default.default.createElement(
    Transition,
    {
      key: notification.id,
      timeout: duration,
    ...
    (state) => /* @__PURE__ */ React__default.default.createElement(
  ...
  return /* @__PURE__ */ React__default.default.createElement(core.OptionalPortal, { withinPortal, ...portalProps }, /* @__PURE__ */ React__default.default.createElement(core.Box, { ...getStyles("root"), ref, ...others }, /* @__PURE__ */ React__default.default.createElement(reactTransitionGroup.TransitionGroup, null, items)));
});
