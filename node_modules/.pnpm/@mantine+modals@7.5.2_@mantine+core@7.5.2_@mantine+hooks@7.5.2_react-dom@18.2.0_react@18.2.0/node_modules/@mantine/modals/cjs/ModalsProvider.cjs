...
function ModalsProvider({ children, modalProps, labels, modals }) {
  ...
  const getCurrentModal = () => {
    ...
    switch (currentModal?.type) {
      case "context": {
        ...
        return {
          modalProps: rest,
          content: /* @__PURE__ */ React__default.default.createElement(ContextModal, { innerProps, context: ctx, id: currentModal.id })
        };
      }
      case "confirm": {
      ...
      case "content": {
        ...
        return {
          modalProps: rest,
          content: /* @__PURE__ */ React__default.default.createElement(React__default.default.Fragment, null, currentModalChildren)
        };
      }
      default: {
        return {
  ...
  return /* @__PURE__ */ React__default.default.createElement(context.ModalsContext.Provider, { value: ctx }, /* @__PURE__ */ React__default.default.createElement(
    core.Modal,
    {
