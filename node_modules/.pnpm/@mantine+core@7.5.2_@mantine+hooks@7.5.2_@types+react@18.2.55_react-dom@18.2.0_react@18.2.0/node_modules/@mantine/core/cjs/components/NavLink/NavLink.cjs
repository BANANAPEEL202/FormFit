...
const NavLink = polymorphicFactory.polymorphicFactory((_props, ref) => {
  ...
  ), /* @__PURE__ */ React__default.default.createElement(Collapse.Collapse, { in: _opened }, /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("children") }, children)));
});
